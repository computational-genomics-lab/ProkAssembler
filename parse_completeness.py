...
with open(input_file, 'r') as f:
  ...
  # Check if the Marker lineage contains 'p__Cyanobacteria'. Replace it with any other desired organism that is taxonomically defined as per CheckM reference genome database, eg: g__Mycobacterium
            if 'p__Cyanobacteria'  in marker_lineage:
                target_bins.append(bin_id)
...
print(f"Identified bins for p__Cyanobacteria: {target_bins}")
